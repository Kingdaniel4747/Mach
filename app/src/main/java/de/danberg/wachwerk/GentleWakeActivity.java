...
public class GentleWakeActivity extends Activity {
    private static WeakReference<GentleWakeActivity> running = new WeakReference<>(null);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        running = new WeakReference<>(this);
    ...
    static void finishIfRunning() {
        GentleWakeActivity activity = running.get();
    ...
    @Override protected void onDestroy() {
        ...
        if (running.get() == this) running.clear();
        super.onDestroy();
    }
}
