...
Die folgenden direkt genutzten Komponenten sind nicht Eigentum des MACH.-Projekts. Die vorhandenen Urheber- und Lizenzhinweise bleiben erhalten.
...
ZXing Core verwendet Apache 2.0. Die vollständige Upstream-Lizenzdatei enthält zusätzliche Hinweise anderer Komponenten des ZXing-Gesamtprojekts; das bedeutet nicht, dass diese Komponenten alle in MACH. verwendet werden.
...
Bei Weitergabe der APK die beigefügten Drittanbieter-Lizenztexte mitliefern. Im vorbereiteten Release-Paket gibt es dafür `MACH-Lizenzen-v1.13.0.zip`.
