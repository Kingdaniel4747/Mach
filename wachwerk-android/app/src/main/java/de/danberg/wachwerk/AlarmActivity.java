...
public class AlarmActivity extends Activity implements SensorEventListener, NfcAdapter.ReaderCallback {
    ...
    private String challengeDescription() { if (is("qr")) return "Geh zu deinem gedruckten MACH-Code."; if (is("nfc")) return "Geh zum Tag und halte das Handy mit der Rückseite daran."; if (is("hold")) return "Halte ohne Unterbrechung " + holdSeconds + " Sekunden."; if (is("snake")) return "Bleib " + snakeSeconds + " Sekunden am bewegten Kopf."; return shakeTarget + " kräftige Bewegungen beenden den Wecker."; }
